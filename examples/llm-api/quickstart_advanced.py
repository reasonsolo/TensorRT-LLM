...
def add_llm_args(parser):
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help='Enable Lamport synchronization kernels for MoE (Rubin+ GPUs)')
    parser.add_argument(
        '--disable_autotuner',
        default=False,
        action='store_true',
        help='Disable autotuner (for debugging, may degrade performance)')
...
def setup_llm(args, **kwargs):
    ...
    llm = LLM(
        ...
        use_lamport_sync=args.use_lamport_sync,
        enable_autotuner=not args.disable_autotuner,
