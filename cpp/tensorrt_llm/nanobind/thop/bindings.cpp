...
void initBindings(nb::module_& m)
{
    ...
    m.def("attention", &torch_ext::attention,
        ...
        nb::arg("flash_mla_num_splits") = std::nullopt, nb::arg("uses_spcompress") = std::nullopt,
        nb::arg("sage_attn_num_elts_per_blk_q") = 0, nb::arg("sage_attn_num_elts_per_blk_k") = 0,
        nb::arg("sage_attn_num_elts_per_blk_v") = 0, nb::arg("sage_attn_qk_int8") = false, nb::arg("num_contexts") = 0,
        nb::arg("num_ctx_tokens") = 0, nb::arg("trtllm_gen_jit_warmup") = false,
        nb::arg("compressed_kv_cache_pool_ptr") = std::nullopt, nb::arg("is_cross") = false,
        nb::arg("cross_kv") = std::nullopt, nb::arg("relative_attention_bias") = std::nullopt,
        nb::arg("relative_attention_max_distance") = 0, nb::arg("spec_decoding_target_max_draft_tokens") = std::nullopt,
        nb::arg("ugpu_id") = -1, nb::arg("quant_scale_qkv") = std::nullopt,
