...
void attention(torch::Tensor q, std::optional<torch::Tensor> k, std::optional<torch::Tensor> v, torch::Tensor& output,
    ...
    std::optional<bool> uses_spcompress = std::nullopt, int64_t sage_attn_num_elts_per_blk_q = 0,
    ...
    std::optional<int64_t> spec_decoding_target_max_draft_tokens = std::nullopt, int64_t ugpu_id = -1,
