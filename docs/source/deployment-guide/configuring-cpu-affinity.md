...
created concurrently may be missed. For PyExecutor, affinity is configured
immediately before the executor worker threads start, after model, KV-cache,
and transceiver construction; later threads inherit their creator's mask.
