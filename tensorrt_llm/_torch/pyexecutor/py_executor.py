...
class PyExecutor:
    ...
    def __init__(
        ...
        logger.info(f"[PyExecutor] TRTLLM_DEBUG_DISAGG_GEN_TIMING={_dbg_env} "
    ...
    def _handle_responses(self):
        ...
        for request in self.active_requests:
            ...
            if (_disagg_dbg_enabled() and request.py_decoding_iter == 1
                ...
                def _ms(a, b):
                    return ((b - a) *
                            1000.0) if (a is not None
                                        and b is not None) else float("nan")
